 ...
 * de base. Aucun fondu : un noir à moitié fondu reste un noir plus clair, et la
 * page n'en a qu'un. Voir CONVENTIONS.md § 19.
 *
    ...
    <main className="min-h-[100svh] flex items-center px-6 md:px-[6vw] py-20">
      <div className="w-full max-w-[1070px] xl:max-w-[74vw] mx-auto">
        ...
        <h1 className="display mt-6 md:mt-8">
          <GrowText text="Je suis Océane" delay={120} spread={620} />
        </h1>

        {/* Le corps est la seule chose ici destinée à se lire comme de la
            prose : c'est donc la seule qui ne crie pas. Voir COPYWRITING.md
            § 12. */}
        <p className="font-plex mt-8 md:mt-10 max-w-2xl text-base md:text-lg leading-[1.6] text-[#0a0a0a]/80">
          Avec mes 8 ans d’expérience, je propose mes compétences en identité
          visuelle, branding et direction artistique, afin de vous accompagner
